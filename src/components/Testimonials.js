        ...
        <div className="grid max-w-xl gap-6 mx-auto lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-16">
          ...
          <div className="lg:ml-auto lg:max-w-sm">
            ...
            <div className="mt-14 flex gap-2.5 lg:mt-12">
              <button className="inline-flex items-center justify-center w-12 h-12 duration-200 bg-white rounded-full shadow-sm carousel-prev shadow-sky-200/75 ring-1 ring-slate-200/60 hover:bg-sky-50/50">
                <svg
              ...
              <button className="inline-flex items-center justify-center w-12 h-12 duration-200 bg-white rounded-full shadow-sm carousel-next shadow-sky-200/75 ring-1 ring-slate-200/60 hover:bg-sky-50/50">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                ...
                >
                  <div className="flex h-full w-full max-w-[272px] flex-1 flex-col">
                    <div className="flex-1">
                      ...
                      <h4 className="text-xl font-medium mt-7 font-display text-slate-900">
